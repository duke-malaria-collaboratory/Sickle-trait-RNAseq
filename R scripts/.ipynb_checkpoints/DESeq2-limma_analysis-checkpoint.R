...
resultsNames(dds)
(ASvAA_Ring <- results(dds, contrast = c("group", "ASRing", "AARing")))
(ASvAA_Troph <- results(dds, contrast = c("group", "ASTrophozoite", "AATrophozoite")))
...
su_rpkm <- read.csv("/Users/joe/Downloads/falciparum_transcriptome_manuscript-master/all_gene_analysis/data/ rpkm_7SexualAndAsexualLifeStages_suetal.csv", header = TRUE, sep = ",")
